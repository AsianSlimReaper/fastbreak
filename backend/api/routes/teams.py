...
# justification: This endpoint allows users to create a new team with the provided details.
@router.post("/", response_model=TeamRead)
def create_team(team_data: TeamCreate, db: Session = Depends(get_db)):
    # create a new team using the provided data
...
#justification: This endpoint allows users to update the details of an existing team.
@router.patch("/{team_id}", response_model=TeamRead)
def update_team(team_id: UUID, team_data: TeamUpdate, db: Session = Depends(get_db)):
    # update the team with the given ID using the provided data
...
#justification: This endpoint retrieves all teams associated with a specific user ID.
...
def get_teams_by_user(user_id: UUID, db: Session = Depends(get_db)):
    # retrieve all teams associated with the given user ID
...
#justification: This endpoint allows users to create a new team membership with the provided details.
...
def create_team_membership(membership_data: TeamMembershipCreate, db: Session = Depends(get_db)):
    # create a new team membership using the provided data
...
# justification: This endpoint allows users to update the details of an existing team membership.
...
def update_team_membership(membership_id: UUID, membership_data: TeamMembershipUpdate, db: Session = Depends(get_db)):
    # update the team membership with the given ID using the provided data
...
# justification: This endpoint retrieves the details of a specific team membership by its ID.
